...
level(lvl_01,State, Prio, X, Y):-
    setLevel(lvl_01, 
        [
            ...
            empty(7,4), searchMoveOk(), prioritary(Prio), target(X), target(Y), mutable(rock),
...
level(lvl_02,State, Prio, X, Y):-
    setLevel(lvl_02, 
        [
            ...
            phys(flag), phys(baba), 
            rule(baba,you), 
            prioritary(Prio), searchMoveOk(), empty(7,4), target(X), target(Y),
...
%%%%%%% LEVEL 03 %%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%
level(lvl_03,State, Prio, X, Y):-
    setLevel(lvl_03, 
        [
            word(is), word(win), word(babaWord), word(you),
            link(baba,babaWord),
            phys(baba),
            rule(baba,you), searchMoveOk(), prioritary(Prio), target(X), target(Y),
...
level(lvl_04,State, Prio, X, Y):-
    setLevel(lvl_04, 
        [
            ...
            searchMoveOk(), prioritary(Prio), empty(2,6), empty(2,3), target(X), target(Y),
...
level(lvl_05,State,Prio, X, Y):-
    setLevel(lvl_05, 
        [
            ...
            rule(baba,you), rule(flag,win),
            prioritary(Prio), searchMoveOk(), empty(7,5), approachable(), target(X), target(Y), mutable(rock),
...
level(lvl_06,State,Prio, X, Y):-
    setLevel(lvl_06, 
        ...
        prioritary(Prio), searchMoveOk(), empty(7,5), target(X), target(Y),
...
level(lvl_08,State, Prio, X, Y):-
    setLevel(lvl_08, 
        ...
        searchMoveOk(), prioritary(Prio), empty(5,4), target(X), target(Y),
...
level(lvl_09,State, Prio, X,Y):-
    setLevel(lvl_09, 
        ...
        searchMoveOk(), prioritary(Prio), empty(5,8), target(X), target(Y),
...
level(lvl_10,State, Prio, X, Y):-
    setLevel(lvl_10, 
        ...
        searchMoveOk(), prioritary(Prio), empty(6,5), target(X), target(Y),
...
level(lvl_11,State, Prio, X, Y):-
    setLevel(lvl_11, 
        ...
        searchMoveOk(), prioritary(Prio), empty(7,7), target(X), target(Y),
...
level(lvl_13,State, Prio, X, Y):-
    setLevel(lvl_13, 
        ...
        searchMoveOk(), prioritary(Prio), empty(4,8), target(X), target(Y),
...
level(lvl_14,State, Prio, X, Y):-
    setLevel(lvl_14, 
        ...
        rule(flag,win), rule(baba,you), rule(wall, stop),
        searchMoveOk(), prioritary(Prio), empty(6,7), target(X), target(Y),
